...
class PurchaseOrder(models.Model):
    ...
    project_id = fields.Many2one(
        ...
        store=True,
        help="The analytic account related to a sales order.",track_visibility='onchange'
    )
            ...
            if po.order_line:
                ...
                for ol in po.order_line:
                    if ol.account_analytic_id != al:
                        ...
                        break
            if al == False:
                if po.custom_requisition_id:
                    po.project_id = po.custom_requisition_id.project_id.analytic_account_id.id
                else:
                    po.project_id = al
            po.project_id = al
