...
class SalaryAdvancePayment(models.Model):
    ...
    def approve_request(self):
        ...
        for each_advance in salary_advance_search:
            ...
            if current_month == existing_month and current_year == datetime.strptime(str(each_advance.date), '%Y-%m-%d').date().year:
        ...
        adv = self.advance
        amt = self.employee_contract_id.total_salary
